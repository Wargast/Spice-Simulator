...
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { dpi }]; #IO_L12N_T1_MRCC_14 Sch=sw[4]
...
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { dpo }]; #IO_L19N_T3_A21_VREF_15 Sch=dp
